...
public class EllipsV2 {
	 ...
	 * ellipsoid. It could result in any quadric (hyperboloid, paraboloid, etc).
	 * If the data is to sparse, the values of the eigenvectors could be
	 * reversed resulting in a fit that is not an ellipsoid.
	 * 
